<div class="max-w-sm w-full lg:max-w-full lg:flex">
    <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url('https://previews.123rf.com/images/mangostar/mangostar1806/mangostar180600960/103357212-smiling-pretty-young-woman-holding-mug-and-looking-at-camera-lady-drinking-tea-or-coffee-break-conce.jpg')" title="Woman holding a mug">
    </div>
